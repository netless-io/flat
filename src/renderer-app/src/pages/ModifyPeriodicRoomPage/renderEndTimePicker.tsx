...
export function renderEndTimePicker(
    ...
    function validateEndTimeDate(): RuleObject {
        return {
            validator: async (_, value: Date) => {
                const beginTime: ModifyPeriodicFormValues["beginTime"] = form.getFieldValue(
                    "beginTime",
                );
    ...
    function validateEndTimeTime(): RuleObject {
        return {
            validator: async (_, value: Date) => {
                ...
                const endDate: ModifyPeriodicFormValues["endTime"]["date"] = form.getFieldValue([
                    "endTime",
                    "date",
                ]);
                if (
    ...
    function disableEndTimeHours(): number[] {
        const {
            beginTime,
            endTime,
        }: Pick<ModifyPeriodicFormValues, "beginTime" | "endTime"> = form.getFieldsValue([
            "beginTime",
            "endTime",
        ]);
