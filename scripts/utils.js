...
const electronVersion = () => {
    const packageJsonFile = editJsonFile(
        path.resolve(__dirname, "..", "packages", "main-app", "package.json"),
    );

    return packageJsonFile.get("devDependencies.electron");
};
module.exports.electronVersion = electronVersion();
